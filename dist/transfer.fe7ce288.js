...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/movements/movements-list.api.js":[function(require,module,exports) {
"use strict";
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-positive-number-validator":"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js"}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";
...
exports.mapTransferFromApiToVm = void 0;
...
var mapTransferFromApiToVm = function mapTransferFromApiToVm(transfer) {
  return _objectSpread(_objectSpread({}, transfer), {}, {
    date: Date(transfer.date)
  });
};

exports.mapTransferFromApiToVm = mapTransferFromApiToVm;
},{}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";

var _movementsList = require("../movements/movements-list.api");
...
if (isEditMode) {
  (0, _movementsList.getAccount)(params.id).then(function (ApiAccount) {
    (0, _transfer.setAccountOptions)(ApiAccount);
  });
} else {
  (0, _movementsList.getAccount)().then(function (ApiAccount) {
    (0, _transfer.setAccountOptions)(ApiAccount);
  });
}
...
(0, _helpers.onUpdateField)('select-account', function (event) {
  ...
  _transfer2.formValidation.validateField('select-account', transfer.accountId).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    day: value,
    date: "".concat(transfer.year, "-").concat(transfer.month, "-").concat(transfer.day)
  });
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(transfer).then(function (result) {
    ...
    var toApi = (0, _transfer4.mapTransferFromApiToVm)(transfer);
    console.log(toApi);

    if (result.succeeded) {
      (0, _transfer3.insertTransfer)(toApi).then(function () {
        _router.history.back();
      });
    }
  });
});
},{"../movements/movements-list.api":"pages/movements/movements-list.api.js","../../core/router":"core/router/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.mappers":"pages/transfer/transfer.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2318" + '/');
