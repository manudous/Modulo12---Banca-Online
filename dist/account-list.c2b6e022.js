...
},{"./utils":"../node_modules/qs/lib/utils.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.mapAccountListFromApiToVm = void 0;

var mapAccountListFromApiToVm = function mapAccountListFromApiToVm(accountList) {
  // mapAccountFromApiToVm
  return accountList.map(function (account) {
    return mapAccountFromApiToVm(account);
  });
};

exports.mapAccountListFromApiToVm = mapAccountListFromApiToVm;
...
var _formats = _interopRequireDefault(require("qs/lib/formats"));
...
(0, _accountList.getAccountList)().then(function (accountList) {
  var viewModelAccountList = (0, _accountList3.mapAccountListFromApiToVm)(accountList);
