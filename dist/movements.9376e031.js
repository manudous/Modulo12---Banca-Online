...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/movements/movements-list.mappers.js":[function(require,module,exports) {
"use strict";
...
var _movementsList = require("./movements-list.api");

var _router = require("../../core/router");

var _movementsList2 = require("./movements-list.mappers");
...
if (isEditMode) {
  (0, _movementsList.getmovementsList)(params.id).then(function (apiMovement) {
    var movement = (0, _movementsList2.mapMovementsListFromApiToVm)(apiMovement);
    (0, _movements.addMovementRows)(movement);
  });
  (0, _movementsList.getAccount)(params.id).then(function (response) {
    account = (0, _movementsList2.mapUsersListFromApiToVm)(response);
  ...
  (0, _movementsList.getmovementsList)().then(function (apiMovement) {
    var movement = (0, _movementsList2.mapMovementsListFromApiToVm)(apiMovement);
    (0, _movements.addMovementRows)(movement);
  });
}
},{"./movements-list.api":"pages/movements/movements-list.api.js","../../core/router":"core/router/index.js","./movements-list.mappers":"pages/movements/movements-list.mappers.js","./movements.helpers":"pages/movements/movements.helpers.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
